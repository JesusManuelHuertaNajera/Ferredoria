            ...
            <div class="column is-two-thirds is-flex is-flex-direction-column is-justify-content-space-between">
              ...
              <form action="guardar.php" method="POST">
                ...
                <div class="field">
                  ...
                  <div class="control">
                    <input class="input" type="text" name="nombre" id="nombre" placeholder="¿Como se llama tu categoría?" onkeyup="this.value = this.value.toUpperCase();" required>
                  </div>
                </div>
                ...
                <div class="field">
                  ...
                  <div class="control">
                    <input class="input" type="text" name="descripcion" id="descripcion"  placeholder="Descripción de la categoría" onkeyup="this.value = this.value.toUpperCase();" required>
                  </div>
                </div>
